<%--<%@ page import="library.constant.ConstantRole" %>--%>
...
<div class="fld">
    <form action="<c:url value="/updateBook" />" method="post">
        ...
        <label>
            New author<br>
            <select name="author" >
<%--                <option disabled value="${requestScope.authorId}">Current author ${requestScope.bookAuthor}</option>--%>
        ...
        <label for="description">
            <textarea id="description" name="description" rows="5" cols="40" required>${requestScope.book.description}</textarea>
        </label> <br>
        <label>
